...
import com.example.bill.exceptions.BillNotFoundException;
...
public class BillService {
    ...
    public Long createBill(Long accountId, BigDecimal amount, Boolean isDefault, Boolean overdraftEnabled) {
        return billRepository.save(new Bill(accountId, amount, isDefault, OffsetDateTime.now(), overdraftEnabled)).getBillId();
    }
